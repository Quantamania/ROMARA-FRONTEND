...
<template>
  <div class="bg-romara-cream min-h-screen">
    ...
    <div v-else-if="trip" class="overflow-x-hidden">
      ...
      <!-- Hero -->
      <section class="relative isolate bg-romara-green-dark min-h-[300px] overflow-hidden text-white sm:min-h-[600px]">
        ...
        <div class="relative flex flex-col justify-between py-8 min-h-[300px] sm:min-h-[600px] romara-container">
          <button
            @click="goBack"
