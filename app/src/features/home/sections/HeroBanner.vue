...
<template>
  <section class="relative isolate min-h-[290px] overflow-hidden bg-romara-green text-white sm:min-h-[68vh] lg:min-h-[calc(100vh-63px)] xl:min-h-[calc(100vh-87px)]">
    <img
    ...
    <div class="romara-container relative flex min-h-[290px] flex-col justify-center py-5 sm:min-h-[68vh] lg:min-h-[calc(100vh-63px)] xl:min-h-[calc(100vh-87px)] sm:py-16">
      <div class="max-w-xl">
