...
// Static content - always shows the first slide's content
const staticContent = {
...
const selectedImage = ref(images[Math.floor(Math.random() * images.length)].image)
</script>
